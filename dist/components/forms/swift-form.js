...
var _swiftDrop = _interopRequireDefault(require("../inputs/swift-drop"));

var _swiftInputText = _interopRequireDefault(require("../inputs/swift-input-text"));

var _swiftInputTextselect = _interopRequireDefault(require("../inputs/swift-input-textselect"));

var _swiftInputColor = _interopRequireDefault(require("../inputs/swift-input-color"));

var _swiftInputDate = _interopRequireDefault(require("../inputs/swift-input-date"));

var _swiftInputCollection = _interopRequireDefault(require("../inputs/swift-input-collection"));

var _swiftInputTime = _interopRequireDefault(require("../inputs/swift-input-time"));

var _swiftInputSlider = _interopRequireDefault(require("../inputs/swift-input-slider"));

var _swiftInputTextChip = _interopRequireDefault(require("../inputs/swift-input-text-chip"));

var _swiftCreditCard = _interopRequireDefault(require("../inputs/swift-credit-card"));

var _swiftButton = _interopRequireDefault(require("../buttons/swift-button"));

var _swiftInputSelectModal = _interopRequireDefault(require("../inputs/swift-input-select-modal"));

var _swiftLabel = _interopRequireDefault(require("../inputs/swift-label"));

var _swiftDivider = _interopRequireDefault(require("../inputs/swift-divider"));

var _swiftInputHidden = _interopRequireDefault(require("../inputs/swift-input-hidden"));

var _swiftInputCheckbox = _interopRequireDefault(require("../inputs/swift-input-checkbox"));

var _swiftInputCheckboxGroup = _interopRequireDefault(require("../inputs/swift-input-checkbox-group"));

var _swiftInputRadio = _interopRequireDefault(require("../inputs/swift-input-radio"));

var _swiftInputMulticheckbox = _interopRequireDefault(require("../inputs/swift-input-multicheckbox"));

var _swiftInputTextarea = _interopRequireDefault(require("../inputs/swift-input-textarea"));

var _swiftSelect = _interopRequireDefault(require("../inputs/swift-select"));

var _swiftMultiselect = _interopRequireDefault(require("../inputs/swift-multiselect"));

var _swiftSubtitle = _interopRequireDefault(require("../inputs/swift-subtitle"));

var _swiftTitle = _interopRequireDefault(require("../inputs/swift-title"));

var _swiftSelectEnum = _interopRequireDefault(require("../inputs/swift-select-enum"));

var _swiftLine = _interopRequireDefault(require("../inputs/swift-line"));

var _swiftMultibutton = _interopRequireDefault(require("../inputs/swift-multibutton"));
    ...
    children: item.type === 'line' ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_swiftLine.default, _objectSpread(_objectSpread({}, item), {}, {
      ...
      onChange: function onChange(val) {
        ...
        if ((0, _typeof2.default)(val) === 'object') {
          ...
          setValues(_objectSpread(_objectSpread({}, values), {}, (0, _defineProperty2.default)({}, item.key, val)));
