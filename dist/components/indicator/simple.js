...
var dotPulse = (0, _styledComponents.keyframes)(_templateObject || (_templateObject = (0, _taggedTemplateLiteral2.default)(["\n\t0% {\n\t\ttransform: scale(0);\n\t\topacity: 0;\n\t}\n\t25% {\n\t\ttransform: scale(0);\n\t\topacity: 0.1;\n\t}\n\t50% {\n\t\ttransform: scale(0.1);\n\t\topacity: 0.3;\n\t}\n\t75% {\n\t\ttransform: scale(0.5);\n\t\topacity: 0.5;\n\t}\n\t100% {\n\t\ttransform: scale(1);\n\t\topacity: 0;\n\t}\n"])));

var IndicatorSimpleStyled = _styledComponents.default.div(_templateObject2 || (_templateObject2 = (0, _taggedTemplateLiteral2.default)(["\n\tdisplay: flex;\n\talign-items: center;\n\t.indicator_simple_dot {\n\t\tposition: relative;\n\t\tmargin-right: 8px;\n\t\twidth: 12px;\n\t\theight: 12px;\n\t\t.pulse {\n\t\t\twidth: 12px;\n\t\t\theight: 12px;\n\t\t\tborder: 6px solid ", ";\n\t\t\tborder-radius: 50%;\n\t\t\tz-index: 10;\n\t\t\tposition: absolute;\n\t\t}\n\n\t\t.dot {\n\t\t\tborder: 10px solid ", ";\n\t\t\tbackground: transparent;\n\t\t\tborder-radius: 50%;\n\t\t\theight: 30px;\n\t\t\twidth: 30px;\n\t\t\tanimation: ", " 3s ease-out;\n\t\t\tanimation-iteration-count: infinite;\n\t\t\tposition: absolute;\n\t\t\ttop: 50%;\n\t\t\tleft: 50%;\n\t\t\tmargin-left: -15px;\n\t\t\tmargin-top: -15px;\n\t\t\tz-index: 1;\n\t\t\topacity: 0;\n\t\t}\n\t}\n\tspan {\n\t\tdisplay: block;\n\t\tfont-size: 16px;\n\t\tfont-weight: 600;\n\t\topacity: 0.75;\n\t\t-webkit-font-smoothing: antialiased;\n\t}\n"])), function (props) {
  return props.color;
}, function (props) {
  return props.color;
}, dotPulse);
