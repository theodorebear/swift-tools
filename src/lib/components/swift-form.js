...
import SwiftDrop from './swift-drop/swift-drop'
import SwiftInputText from './swift-input-text/swift-input-text'
import SwiftInputTextSelect from './swift-input-textselect/swift-input-textselect'
import SwiftInputColor from './swift-input-color/swift-input-color'
import SwiftInputDate from './swift-input-date/swift-input-date'
import SwiftInputCollection from './swift-input-collection/swift-input-collection'
import SwiftInputTime from './swift-input-time/swift-input-time'
import SwiftInputSlider from './swift-input-slider/swift-input-slider'
import SwiftInputTextChip from './swift-input-text-chip/swift-input-text-chip'
import SwiftInputCode from './swift-input-code/swift-input-code'
import SwiftCreditCard from './swift-credit-card'
import SwiftButton from './swift-button/swift-button'
import SwiftSelectModal from './swift-input-select-modal/swift-input-select-modal'

import SwiftLabel from './swift-label/swift-label'
import SwiftDivider from './swiftDivider'
import SwiftInputHidden from './swift-input-hidden/swift-input-hidden'
import SwiftInputCheckbox from './swift-input-checkbox/swift-input-checkbox'
import SwiftInputCheckboxGroup from './swift-input-checkbox-group/swift-input-checkbox-group'
import SwiftInputRadio from './swift-input-radio/swift-input-radio'
import SwiftMultiCheckbox from './swift-input-multicheckbox/swift-input-multicheckbox'
import SwiftInputTextarea from './swift-input-textarea/swift-input-textarea'
import SwiftSelect from './swift-select/swift-select'
import SwiftMultiSelect from './swift-multiselect/swift-multiselect'
import SwiftSubtitle from './swift-subtitle/swift-subtitle'
import SwiftTitle from './swift-title/swift-title'
import SwiftSelectEnum from './swift-select-enum/swift-select-enum'
import SwiftLine from './swift-line/swift-line'
import SwiftMultiButton from './swift-multibutton/swift-multibutton'
